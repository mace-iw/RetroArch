...
static const struct retro_keybind retro_keybinds_1[] = {
   ...
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_6A, RETROK_j,
      RETRO_DEVICE_ID_JOYPAD_6A, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_6B, RETROK_j,
      RETRO_DEVICE_ID_JOYPAD_6B, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_6C, RETROK_j,
      RETRO_DEVICE_ID_JOYPAD_6C, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_6X, RETROK_j,
      RETRO_DEVICE_ID_JOYPAD_6X, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_6Y, RETROK_j,
      RETRO_DEVICE_ID_JOYPAD_6Y, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_6Z, RETROK_j,
      RETRO_DEVICE_ID_JOYPAD_6Z, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
